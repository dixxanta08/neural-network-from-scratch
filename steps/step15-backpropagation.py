...
neurons_layer_1 = [Neuron(np.array(rng.random(3)), rng.random()) for _ in range(0,4)]
neurons_layer_2 = [Neuron(np.array(rng.random(4)), rng.random()) for _ in range(0,4)]
...
neural_network.train(inputs=inputs, epochs=20, targets=targets, alpha=0.1)
